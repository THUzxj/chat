...
cp ${GOSRC}/$SRC_DIR/chatbot/python/chatbot.py ./releases/tmp
cp ${GOSRC}/$SRC_DIR/chatbot/python/quotes.txt ./releases/tmp
cp ${GOSRC}/$SRC_DIR/chatbot/python/requirements.txt ./releases/tmp

tar -C ${GOSRC}/$SRC_DIR/releases/tmp -zcf ./releases/${version}/py-chatbot.tar.gz .
pushd ./releases/tmp > /dev/null
...
cp ${GOSRC}/$SRC_DIR/tn-cli/*.py ./releases/tmp
cp ${GOSRC}/$SRC_DIR/tn-cli/*.txt ./releases/tmp

tar -C ${GOSRC}/$SRC_DIR/releases/tmp -zcf ./releases/${version}/tn-cli.tar.gz .
pushd ./releases/tmp > /dev/null
